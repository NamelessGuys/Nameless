...
const Settings = ({
  ...
  const [showNSFW, setShowNSFW] = useState(settings.settings.showNSFW);
  const [blurNSFW, setBlurNSFW] = useState(settings.settings.blurNSFW);
  const [emailNotif, setEmailNotif] = useState(settings.settings.emailNotif);
            ...
            <label className='switch'>
              <input
                ...
                onClick={() => {
                  ...
                  updateSettings({ showNSFW, blurNSFW, emailNotif }, user._id);
                }}
              />
